...
import time
import sys
AUDIT_DIR=Path(__file__).resolve().parents[2]/'round5'/'structural_audit'
...
(Path(__file__).resolve().parent/'complete_short_corner_audit_results.json').write_text(json.dumps(result,indent=2)+'\n')
