#!/usr/bin/env python3
"""Finite Lemma 2.5: recursive profiles and explicit offsets."""
...
def check():
    ...
    return dict(schema_version=1, component="short-corner-offsets", status="PASS",
...
def main():
    ...
    try:
        ...
        print(f"short-corner offsets failed: {error}", file=sys.stderr)
        return 1
    return 0
