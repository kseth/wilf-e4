#!/usr/bin/env python3
"""Independent B4 check: Cartesian profiles, literal cube, successor paths."""
...
def verify():
    ...
    return dict(schema_version=1, component="R4b-successors", status="PASS",
...
def main():
    ...
    try:
        ...
        print(f"R4b successors failed: {error}", file=sys.stderr)
        return 1
    return 0
