...
The dimension-independent criteria reviewed in Section~\ref{sec:related}
cover substantial regions, but do not supply the missing uniform geometric
surplus for a fixed \(e>4\).
