...
\hypersetup{colorlinks=true,linkcolor=blue,citecolor=blue,urlcolor=blue,
  pdftitle={Wilf's inequality for numerical semigroups of embedding dimension four},
...
\title{Wilf's inequality for numerical semigroups\\of embedding dimension four}
...
\maketitle
\begin{abstract}
We present a computer-assisted proof of Wilf's inequality for numerical
...
establish quantitative surplus bounds over the weighted downset mean
inequality, sufficient to absorb the exact correction in the Ap\'ery genus
formula.
...
finite assertions. The three-plane case is entirely analytic. Each
