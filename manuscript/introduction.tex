...
Two published computer-assisted results establish Wilf's inequality for
multiplicities through 19: Bruns, Garc\'ia-S\'anchez, O'Neill, and Wilburne
...
The proof supplies three ingredients beyond these foundations: the
compatibility-graph derivation of the central-box/three-horn decomposition;
continuous moment bounds for that geometry together with a translated-mesh
transfer; and branchwise surplus estimates that reduce the remaining cases to
exact finite assertions.
Together they strengthen the weighted lower-ideal baseline enough to absorb
the genus correction.

The weakest uniform conclusion used below is
...
Section~\ref{sec:proof} gives the proof and its finite assertions.
Section~\ref{sec:analytic} supplies three longer analytic arguments integral
to that proof. Section~\ref{sec:verification} describes the finite
verification and accompanying code. The final two mathematical sections
discuss extensions beyond four generators and related work. We conclude with an
